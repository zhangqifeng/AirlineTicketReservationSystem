<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入航班名称" style="width: 200px" v-model="username"></el-input>
      <el-input placeholder="请输入出发站" style="width: 200px" v-model="startairport"></el-input>
      <el-input placeholder="请输入到达站" style="width: 200px" v-model="endairport"></el-input>
