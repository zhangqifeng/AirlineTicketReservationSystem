  ...
  <div class="main-content">
    ...
    <div style="width: 50%; margin: 20px auto; display: flex">
      <div style="flex: 1; text-align: center">
        <img src="@/assets/imgs/airticket.png" alt="" style="height: 100px; width: 100px; cursor: pointer" @click="$router.push('/front/airTicket')">
        <div style="margin-top: 10px; font-size: 16px; color: #404144">飞机票预订</div>
      </div>
      <div style="flex: 1; text-align: center">
        <img src="@/assets/imgs/train.png" alt="" style="height: 100px; width: 100px; cursor: pointer">
        <div style="margin-top: 10px; font-size: 16px; color: #404144">火车票预订</div>
      </div>
      <div style="flex: 1; text-align: center">
        <img src="@/assets/imgs/busticket.png" alt="" style="height: 100px; width: 100px; cursor: pointer">
